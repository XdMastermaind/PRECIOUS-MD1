...
│ ⚙️ *Features:* Premium, Fast, Smart
│ 👑 *Developer:* Watson Official
│ ⚡ *Online:* ${online}
│ 🔰 *Prefix:* ${prefix}
│ ⚙️ *Mode:* ${mode}
│ 👁 *Status View:* ${status}
...
if (senderNumber.includes("263781330745") && !isReact) {
  const reactions = ["👑", "🫜", "🫆", "🫩", "💸", "🪉", "💰", "🫟"];
