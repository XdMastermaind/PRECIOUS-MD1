...
cmd({
  ...
  try {
    ...
    // GitHub stats
    const githubRepo = 'https://github.com/watson-xd6/PRECIOUS-MD';

    // Check update status
    let updateMessage = `*✅ ʏᴏᴜʀ precious-md ʙᴏᴛ ɪs ᴜᴘ-ᴛᴏ-ᴅᴀᴛᴇ!*`;
    if (localVersion !== latestVersion) {
      updateMessage = `*😵‍💫 ʏᴏᴜʀ precious-md ɪs ᴏᴜᴛᴅᴀᴛᴇᴅ!*
